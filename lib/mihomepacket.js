...
function Packet(token) {
    ...
    this.getRaw = function () {
        if (this.data.length > 0) {
            ...
            //var zwraw = new Buffer(this.magic.toString('hex')+this.len.toString('hex')+this.unknown.toString('hex')+this.serial.toString('hex')+this.stamp.toString('hex')+"00000000000000000000000000000000"+this.data.toString('hex'),'hex');
